...
const RoomHeader = ({ roomId, peer }) => {
  const {
    rooms: { socket, openedRoom, roomEndedForAll },
    auth: { user },
    ...
    >
      ...
      <Grid item>
        <Button
          ...
          sx={style.meetingDetailsBtn}
          onClick={() => setOpenMeetingDetailsDialog(true)}
        >
          Room details
        </Button>
      </Grid>
      ...
      <RoomDetails
        openMeetingDetailsDialog={openMeetingDetailsDialog}
        setOpenMeetingDetailsDialog={setOpenMeetingDetailsDialog}
        roomId={roomId}
      />
      ...
      <EndRoom
        openEndMeetingDialog={openEndMeetingDialog}
        setOpenEndMeetingDialog={setOpenEndMeetingDialog}
        leaveRoom={leaveRoom}
        endRoomForAll={endRoomForAll}
        user={user}
