                  ...
                  {openedRoomParticipants &&
                    openedRoomParticipants[user._id].isVideoOff && (
                      <img
                        alt="avatar"
                        src={
                          openedRoomParticipants[user._id].avatar ||
              ...
              <SwiperSlide>
                {!isGuestVideoExpanded ? (
                      ...
                      ? [
                          ...
                          return (
                            <Grid
                              ...
                              sx={style.guest}
                              key={stream.id}
                              onClick={() => expandGuestVideo(peerId, stream)}
                            >
                              {openedRoomParticipants ? (
                                openedRoomParticipants[peerId].isVideoOff ? (
                                  <img
                                    alt="avatar"
                                    src={
                                      openedRoomParticipants[peerId].avatar ||
                                      "/images/monkey-avatar.png"
                                    }
                                    style={style.guestMedia}
                                  />
                                ) : (
                  ...
                  <Box sx={style.expandedGuestContainer}>
                    <IconButton
                      sx={style.expandedVideoBackBtn}
                      onClick={shrinkGuestVideo}
                    >
                      <CloseIcon />
                    </IconButton>
                    {openedRoomParticipants ? (
                      openedRoomParticipants[expandedGuestData.peerId]
                        ...
                        <GuestVideo
                          stream={expandedGuestData.stream}
                          style={style}
                          expanded={true}
                        />
                      )
            ...
            {receivedFiles.map((receivedFile) => {
              return (
                <Box sx={style.receivedFile} key={receivedFile.cloudinaryId}>
                  ...
                  <Fab
                    sx={style.receivedFileDownloadBtn}
                    onClick={() => downloadFile(receivedFile)}
                  >
                    <FileDownloadIcon />
                  </Fab>
                  <Fab
                    sx={style.receivedFileCrossBtn}
                    onClick={() =>
                      dispatch(
                        removeFileFromReceivedFiles(receivedFile.cloudinaryId)
                      )
                    }
                  >
                    <CloseIcon />
